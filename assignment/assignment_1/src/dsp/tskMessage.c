...
/* Variable for stroing input and result matrix */
int16_t matA[MAT_SIZE][MAT_SIZE]
int16_t matB[MAT_SIZE][MAT_SIZE]
int32_t matRes[MAT_SIZE][MAT_SIZE]
