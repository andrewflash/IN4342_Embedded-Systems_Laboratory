...
short int* gaussian_smooth(unsigned char *image, int rows, int cols, float sigma)
{
    ...
    short int* smoothedim;  /* Smoothed image */
...
/*******************************************************************************
* PROCEDURE: canny_baseline
* PURPOSE: To perform canny edge detection as baseline.
*******************************************************************************/
           ...
           float tlow, float thigh, unsigned char **edge_base)
{
    ...
    char *fname = NULL;    /* Default is null, same as canny */
    ...
    ****************************************************************************/
    ...
    if( (*edge_base=(unsigned char *)malloc(rows*cols*sizeof(unsigned char))) == NULL )
    {
        fprintf(stderr, "Error allocating the edge image.\n");
        exit(1);
    }
    apply_hysteresis(magnitude, nms, rows, cols, tlow, thigh, *edge_base);
