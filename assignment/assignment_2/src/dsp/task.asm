...
;* Date/Time created: Mon May  9 15:31:48 2016                                *
;******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	...
	.dwattr $C$DW$CU, DW_AT_comp_dir("/data/home/in4342-01/PengqiChen/Assign2/pool_notify/dsp")
;*****************************************************************************
;* CINIT RECORDS                                                             *
;*****************************************************************************
	.sect	".cinit"
...
;	/data/bbToolChain/usr/local/share/c6000/bin/opt6x /tmp/020263rbIWh /tmp/02026XjtEwx 
	.sect	".text"
	.clink
	.global	_sum_dsp
...
$C$DW$45	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$45, DW_AT_name("/data/home/in4342-01/PengqiChen/Assign2/pool_notify/dsp/task.asm:$C$L3:1:1462800708")
...
$C$DW$47	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$47, DW_AT_name("/data/home/in4342-01/PengqiChen/Assign2/pool_notify/dsp/task.asm:$C$L1:1:1462800708")
...
$C$DW$61	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$61, DW_AT_name("/data/home/in4342-01/PengqiChen/Assign2/pool_notify/dsp/task.asm:$C$L9:1:1462800708")
...
$C$DW$63	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$63, DW_AT_name("/data/home/in4342-01/PengqiChen/Assign2/pool_notify/dsp/task.asm:$C$L7:1:1462800708")
