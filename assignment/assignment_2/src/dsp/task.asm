...
;* Date/Time created: Thu May 19 21:42:06 2016                                *
;******************************************************************************
...
;	/data/usr/local/share/c6000/bin/opt6x /tmp/05883FbwYv0 /tmp/05883V6TudH 
	.sect	".text"
	.clink
	.global	_sum_dsp
...
$C$DW$45	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$45, DW_AT_name("/home/ubuntu/Documents/Assig2/pool_notify/dsp/task.asm:$C$L3:1:1463686926")
...
$C$DW$47	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$47, DW_AT_name("/home/ubuntu/Documents/Assig2/pool_notify/dsp/task.asm:$C$L1:1:1463686926")
...
$C$DW$61	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$61, DW_AT_name("/home/ubuntu/Documents/Assig2/pool_notify/dsp/task.asm:$C$L9:1:1463686926")
...
$C$DW$63	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$63, DW_AT_name("/home/ubuntu/Documents/Assig2/pool_notify/dsp/task.asm:$C$L7:1:1463686926")
